...
- **Chat Assistant (Python + OpenAI + Gradio)**  
  *August 2025*  
  - Built an interactive chat assistant using **Python** and **OpenAI GPT-3.5-Turbo**  
  - Implemented conversational memory to maintain context across interactions  
  - Created a simple, shareable web interface using **Gradio**  
  - Designed for easy customization of system prompts for different domains  

  🛠️ **Tech Used:**  
  ![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)
  ![OpenAI](https://img.shields.io/badge/OpenAI-412991?style=flat&logo=openai&logoColor=white)
  ![Gradio](https://img.shields.io/badge/Gradio-FF6F00?style=flat&logoColor=white)
